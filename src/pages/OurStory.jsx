    ...
    <>
      <Hero>
        <div className="text-center">
          <h1 className="mt-24 font-bold font-dancing-script text-3xl">
            Our Story
          </h1>
        </div>
      </Hero>
        ...
        <main className="max-w-6xl mx-auto px-4 py-16">
          ...
          <section className="grid md:grid-cols-2 gap-12 items-center">
            <AnimatedLayout direction="right">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                What started as a small family kitchen with big dreams soon
                turned into a place where flavors speak louder than words. Our
                restaurant was born from a deep love for authentic vegetarian
                food and the joy of serving people.
              </p>
          ...
          <section className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedLayout direction="left" className="order-1 md:order-2">
              ...
              <p className="text-gray-700 leading-relaxed">
                No shortcuts. No compromises. Just pure taste and soulful
                cooking.
              </p>
            </AnimatedLayout>
          </section>
